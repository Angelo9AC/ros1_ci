...
Then, go to the cd simulation_ws/src/ros1_ci directory and type:
...
Then, you need to go to the jenkins__pid__url.txt file which is inside the webpage_ws and copy the link that is inside it and paste it in your browser. You will be able to enter to the jenkins webpage and access with the following user and password:
